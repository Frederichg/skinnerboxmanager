...
exp = data.ExperimentHandler(name="OUT", version='',
    ...
    #originPath='C:\\Users\\jacov\\OneDrive\\Documents\\untitled_psycho\\untitled_lastrun.py',
    originPath='C:\\Users\\pfh3221\\OneDrive - Université de Moncton\\Documents\\GitHub2\\skinnerboxmanager\\untitled_lastrun.py',
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\pfh3221\\OneDrive - Université de Moncton\\Documents\\GitHub2\\skinnerboxmanager\\GDgrating.py',
...
# *aperture* updates
        ...
        if mouse.getPos()[0] != 0:
            ...
            if (mouse.getPos()[0] > 0 and responses == 1) or (mouse.getPos()[0] < 0 and responses == 0):
                ...
                GPIO.send("FDR")
                log('FDR')
                while GPIO.send(IR, True) != "1" or GPIO.send(IR, True) != 1:
                    continue
                log('IR')
