...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\pfh3221\\OneDrive - Université de Moncton\\Documents\\GitHub2\\skinnerboxmanager\\GDgratingFHG13mars2024_lastrun.py',
...
grating = visual.GratingStim(
    ...
    ori=0.0, pos=(0, 0), size=(2, 1), sf=15.0, phase=0.0,
