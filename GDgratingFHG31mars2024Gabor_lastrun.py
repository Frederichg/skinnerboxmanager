...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\pfh3221\\OneDrive - Université de Moncton\\Documents\\GitHub2\\skinnerboxmanager\\GDgratingFHG31mars2024Gabor_lastrun.py',
...
for thisTrial_4 in trials_4:
    ...
    while continueRoutine and routineTimer.getTime() < 1.0:
        ...
        if bkg_trialstart.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > bkg_trialstart.tStartRefresh + 1.0-frameTolerance:
                # keep track of stop time/frame for later
        ...
        if txt_trialstart.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > txt_trialstart.tStartRefresh + 1.0-frameTolerance:
                # keep track of stop time/frame for later
...
# *Stim_presentation* updates
    ...
    for thisTrial_3 in trials_3:
        ...
        while continueRoutine and routineTimer.getTime() < 2.0:
            ...
            if bkg_omission.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > bkg_omission.tStartRefresh + 2.0-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if txt_omission.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > txt_omission.tStartRefresh + 1.0-frameTolerance:
                    # keep track of stop time/frame for later
    ...
    while continueRoutine and routineTimer.getTime() < 1.5:
        ...
        if ITI_delay.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > ITI_delay.tStartRefresh + 1.5-frameTolerance:
                # keep track of stop time/frame for later
